...
SRC= libft/ft_isalpha.c libft/ft_isdigit.c libft/ft_isalnum.c libft/ft_isascii.c libft/ft_isprint.c libft/ft_itoa.c \
    ...
    parsing/10_heredoc_processing.c parsing/11_heredoc_utils.c parsing/13_parsing_utils.c \
    ...
    execution/utils_d.c execution/utils_e.c execution/ft_malloc_free.c parsing/12_heredoc_utils.c syntax_error.c
